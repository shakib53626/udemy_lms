                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="{{ (!empty($profileData->image)) ? url('uploads/admin_images/'.$profileData->image) : 'https://dummyimage.com/450x450/f3f3f3/4f4f4f' }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                            <div class="mt-3">
