            ...
            <div class="col-lg-10 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('register.instructor') }}" class="row">
                            @csrf
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input id="phone" class="form-control form--control @error('address') is-invalid @enderror" type="text" name="phone" placeholder="Phone Number">
                                </div>
                                @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="address" placeholder="Address Details">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input id="password" class="form-control form--control @error('password') is-invalid @enderror" type="password" name="password">
                                </div>
                                @error('password')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
